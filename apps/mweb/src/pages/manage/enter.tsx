                        ...
                        >
                            <Card>
                                ...
                                <Wrap position='relative' align='flex-start'>
                                    <p className={cx(styles.date)} style={{ position: true ? 'absolute' : 'relative' }}>2023년 5월 16일 요청</p>
...
const acceptSvg = <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="green" viewBox="0 0 24 24">
    <path d="M20.285 6.709a1 1 0 00-1.414-1.418l-9.192 9.192-4.242-4.242a1 1 0 10-1.414 1.414l5 5a1 1 0 001.414 0l10-10z" />
</svg>;

const rejectSvg = <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="red" viewBox="0 0 24 24">
