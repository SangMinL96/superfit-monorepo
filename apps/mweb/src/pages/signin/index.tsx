  ...
  return (
    <div className={clsx(styles.wrap)}>
      ...
      <form className={clsx(styles.form_box)}>
        <OblongInput height='64px' name='id' type='text' placeholder={{ text: '아이디' }} />
        <Divide value={10} marginOnly />
        <OblongInput height='64px' name='pw' type='password' placeholder={{ text: '비밀번호' }} />
      </form>
      <Divide value={25} marginOnly />
      <Button name='login' type='button' size={64}>
        로그인
      </Button>
