...
function SignupForm() {
  return (
    <div className={cx(styles.wrap)}>
      <motion.h5 {...mountFadeIn} className={cx(styles.tit)}>회원정보입력</motion.h5>
      ...
      <p className={cx(styles.input_desc)}>
        영문 대/소문자, 숫자, 특수문자 (~!@#$%^&*()_+|) 중 2종류를 조합하여 10~16자 또는 3종류 이상을 조합하여 8~16자로
        입력해주세요.
      </p>
      <div className={cx(styles.input_box)}>
        <Input name='age' type='text' placeholder={{ text: '‘-’ 제외하고 숫자만 입력' }} label='휴대폰번호' required />
